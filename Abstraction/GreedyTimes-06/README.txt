...
Next to you, there is a bag which unfortunately has limited space.
You don't have much time, so you need to take as much wealth as possible!
But to get a bigger amount of the most valuable items, you need to keep the following rules:
...
If you read an item that breaks one of these rules you should not put it in the bag.
...
You will receive the content of the safe on a single line in the format "{item} {quantity}" pairs, separated by whitespace.
...
Reading item's names should be CASE-INSENSITIVE, except when the item is Cash.
You should aggregate items' quantities that have the same name.

If you've kept the rules you should escape successfully with a bag full of wealth.
Now it's time to review what you have managed to get out of the safe.
Print all the types ordered by the total amount in descending order. 
