...
public class ExceptionMessage {
    ...
    public static final String EXISTING_COMPONENT_FORMAT = "Component %s already exists in %s with Id %d.";

    public static final String EXISTING_PERIPHERAL_FORMAT = "Peripheral %s already exists in %s with Id %d.";

    public static final String NOT_EXISTING_COMPONENT_FORMAT = "Component %s does not exist in %s with Id %d.";

    public static final String NOT_EXISTING_PERIPHERAL_FORMAT = "Peripheral %s does not exist in %s with Id %d.";
    ...
    public static final String CAN_NOT_BUY_COMPUTER_FORMAT = "Can't buy a computer with a budget of ${%.2f}.";
